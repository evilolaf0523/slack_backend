...
const onConnect = (socket) => {
    ...
    socket.on(`${REQUEST.CHANNEL}_${METHOD.UPDATE}`, (data) => { console.log("channel---------------------------",data); authMdr(socket, data, channelCtr.update) });
    ...
    socket.removeListener(`${REQUEST.CHANNEL}_${METHOD.CREATE}`, (data) => authMdr(socket, data, channelCtr.create));
    socket.removeListener(`${REQUEST.CHANNEL}_${METHOD.READ}`, (data) => authMdr(socket, data, channelCtr.read));
    socket.removeListener(`${REQUEST.CHANNEL}_${METHOD.UPDATE}`, (data) => authMdr(socket, data, channelCtr.update));
    socket.removeListener(`${REQUEST.CHANNEL}_${METHOD.DELETE}`, (data) => authMdr(socket, data, channelCtr.delete));
    socket.removeListener(`${REQUEST.MESSAGE}_${METHOD.CREATE}`, (data) => authMdr(socket, data, messageCtr.create));
    socket.removeListener(`${REQUEST.MESSAGE}_${METHOD.READ}`, (data) => authMdr(socket, data, messageCtr.read));
    socket.removeListener(`${REQUEST.MESSAGE}_${METHOD.UPDATE}`, (data) => authMdr(socket, data, messageCtr.update));
    socket.removeListener(`${REQUEST.MESSAGE}_${METHOD.DELETE}`, (data) => authMdr(socket, data, messageCtr.delete));
    socket.removeListener(REQUEST.EMOTICON, (data) => authMdr(socket, data, messageCtr.emoticon));
    socket.removeListener(REQUEST.TYPING, (data) => authMdr(socket, data, messageCtr.typing));
}
